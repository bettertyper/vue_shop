  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="userList" border stripe>             <!--border属性为true时添加边框；stripe属性为true时隔行变色-->
        ...
        <el-table-column label="姓名" prop="username"></el-table-column>      <!--prop属性值需要是userList中的每个元素对象中的key名(注意和el-form-item中的prop属性区分)-->
...
<script>
  export default {
    ...
    methods: {
      ...
      //点击分配角色按钮，获取用户信息，请求角色列表，显示'分配角色'对话框
      ...
      //分配角色对话框关闭时，重置SelectedRoleId和userInfo
      setRoleDialogClosed(){
        this.SelectedRoleId = '';
        this.userInfo = {};
      }
